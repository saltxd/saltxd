...
IT professional building infrastructure automation and AI-powered tools.
...
🤖 **AI Integration** — Building tools that connect Claude to real infrastructure via MCP servers, SSH automation, and natural language interfaces
